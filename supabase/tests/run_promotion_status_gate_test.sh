#!/usr/bin/env bash
# Run the HEL-83 promotion status-gate proof
# (promotion_status_gate_test.sql) against the LOCAL Supabase stack.
...
#
# ⚠️  RED-FIRST: §B and §C EXIT NON-ZERO against the pre-fix functions by design —
# neither offer_promotion nor accept_promotion looked at deal_card.status at all.
# They go GREEN once 20260903110000_promotion_status_gate.sql lands.
#
...
TEST_FILE="supabase/tests/promotion_status_gate_test.sql"
