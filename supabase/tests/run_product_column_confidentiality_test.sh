#!/usr/bin/env bash
# Run the T13 product-column-confidentiality proof (product_column_confidentiality_test.sql) against the
...
TEST_FILE="supabase/tests/product_column_confidentiality_test.sql"
