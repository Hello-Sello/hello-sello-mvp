#!/usr/bin/env bash
# Run the HEL-67 msg_all deal_detected gate proof
# (msg_all_deal_detected_gate_test.sql) against the LOCAL Supabase stack.
...
#
# ⚠️  RED-FIRST: §B and §E cells EXIT NON-ZERO against the
# pre-fix schema by design — msg_all has no type predicate.
# They go GREEN once 20260825110000_msg_all_deal_detected_gate.sql lands.
#
...
TEST_FILE="supabase/tests/msg_all_deal_detected_gate_test.sql"
