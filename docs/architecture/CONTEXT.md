...
This file is the canonical glossary for the Hello Sello domain. Agents read this to understand product-specific terminology before writing code, architecture docs, or tests.
...
*Keep this file up to date as new domain terms are locked in the Layer docs.*
