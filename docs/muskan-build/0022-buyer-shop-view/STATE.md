...
stage:  triage ✅ · spec ✅ (G1) · prototype ✅ (G2) · design ✅ (G3 2026-08-19) ·
        ...
        **▶ T08 IN FLIGHT (2026-08-23) — the slug's LAST ticket. PLAN rev 1 written; doc-only,
        so no test-writer and `critic` alone. Base frozen at `0094f5d`, 0 behind `origin/dev`.**
