...
stage:  triage ✅ · spec ✅ (G1) · prototype ✅ (G2) · design ✅ (G3 2026-08-19) ·
        ...
        **▶ T08 ⛔ BLOCKED AT PLAN (2026-08-23) — checker 2/2 SPENT, did NOT converge (round 2 =
        5 blocking, ALL NEW). 🔴 A DOC-ONLY XS TICKET FOUND A PRODUCTION SECURITY REGRESSION IN THE
        SHIP BATCH: `20260607090000` re-grants `execute on functions` to `anon` as a DEFAULT
        PRIVILEGE, and on a cloud push it runs AFTER the session-77 revoke that removed it — so it
        re-widens prod and nothing narrows it again. NEEDS MUSKAN → `blocked.md`.**
