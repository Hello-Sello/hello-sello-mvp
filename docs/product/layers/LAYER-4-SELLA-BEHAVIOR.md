...
- **Back-of-card SIGNALS** — 8+ signal types generated by Deal-Sella. **MVP:** one neutral insight per Deal Card, shown identically to both sides. **Post-MVP:** two viewer-aware slots, premium-gated. *(See DEV-5 for the locked signal types; DEV-50 for the personalization lock; DEV-48 / DEV-49 for compute / storage follow-ups.)*
...
- **Back-of-card SIGNALS** → see [DEV-5](https://linear.app/hellosello/issue/DEV-5/what-content-should-appear-on-the-back-of-the-deal-card-the-flip-side) for the 8 locked signal types and [DEV-50](https://linear.app/hellosello/issue/DEV-50/personalize-back-of-card-signals-per-viewer-premium-feature) for the personalization lock (MVP = 1 neutral insight shown to both sides; post-MVP = viewer-aware, premium-gated). Compute / storage follow-ups: [DEV-48](https://linear.app/hellosello/issue/DEV-48), [DEV-49](https://linear.app/hellosello/issue/DEV-49).
...
- **§6 back-of-card SIGNALS personalization (DEV-50):** MVP = one neutral insight per Deal Card, shown identically to both sides (preserves Deal-Sella's structural neutrality, §3); post-MVP = two viewer-aware slots (buyer + seller), premium-gated. Viewer-role detection deferred. *(2026-05-23.)*
